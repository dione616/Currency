  ...
  return (
    <TableRow key={item.ccy}>
      <TableCell component="th" scope="row">
        <span className="item-currency">{`${item.ccy}/${item.base_ccy}`}</span>
      </TableCell>
      ...
      {isShown ? (
        editable ? (
          ...
          >
            <span className="item-price">{price.buy}</span>
            <FontAwesomeIcon
              icon={faPen}
              onClick={() => {
                setEditable(true);
      ...
      {isShown ? (
        editable ? (
          ...
          >
            <span className="item-price">{price.sale}</span>
            <FontAwesomeIcon
              icon={faPen}
              onClick={() => {
                setEditable(true);
